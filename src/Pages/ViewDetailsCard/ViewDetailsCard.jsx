...
const ViewDetailsCard = () => {
  ...
  return (
    <div>
      <h2 className="text-center font-bold my-10 uppercase p-3 text-6xl underline text-orange-500">
        Toy Description
      </h2>
        ...
        <div className="hero min-h-screen bg-base-200">
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div className="font-serif">
              ...
              <h1 className="text-2xl font-bold my-3 py-3">
              ...
              <button className="btn bg-orange-700 border-none text-black">
                BUY NOW
              </button>
            </div>
          </div>
